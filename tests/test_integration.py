...
class TestTTSIntegration:
    ...
    def test_chunking_integration(self):
        ...
        from TTS_ka.chunking import adaptive_chunk_text, smart_chunk_text
    ...
    def test_language_validation_integration(self):
        ...
        from TTS_ka.fast_audio import get_voice_for_language, validate_language
    ...
    async def test_concurrent_operations(self, temp_dir):
        ...
        texts = ["First concurrent text", "Second concurrent text", "Third concurrent text"]
